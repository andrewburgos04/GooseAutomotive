      ...
      <div className="mx-auto grid min-h-[calc(100vh-80px)] max-w-6xl items-center gap-10 px-6 py-12 lg:grid-cols-2">
        <div>
          ...
          <p className="mt-5 max-w-md text-muted">
            Same family. Same 3-year / 36,000-mile warranty. Job board, 32-point DVI, estimates, and clocks — built for the bay, not the brochure.
          </p>
        </div>
        <div className="rounded-2xl bg-white p-5 shadow-card">
          <h2 className="mb-4 text-2xl font-extrabold text-navy">Sign in as a teammate</h2>
